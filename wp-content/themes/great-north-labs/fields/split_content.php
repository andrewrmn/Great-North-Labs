...
<div class="split-block <?php if(get_sub_field('image_on_right')) { ?>split-block--flip bg-whiteS<?php } ?>">
    <div class="split-block__intro">
        ...
        <div class="split-block__intro-text">
            <div>
                ...
                <div class="split-block__intro-text_num"><?php the_sub_field('number'); ?></div>
                <?php endif; ?>
                <?php if(get_sub_field('title')): ?>
                <div class="h4 split-block__intro-text__title"><?php the_sub_field('title'); ?></div>
                <?php endif; ?>
            </div>
        </div>
    </div>
    ...
    <div class="split-block__content text-group-tall">
        ...
        <div class="user-content"><?php the_sub_field('body'); ?></div>
        <?php endif; ?>
